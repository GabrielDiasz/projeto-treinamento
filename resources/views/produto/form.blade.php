...
<div class="container">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="preco" type="text" class="form-control preco @error('preco') is-invalid @enderror" name="preco" value="{{ isset($data) ? $data->preco : '' }}" autocomplete="preco" required autofocus>
            @error('preco')
            <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
